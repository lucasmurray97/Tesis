...
import copy
# A2C algorithm:
def actor_critic_batched(env, net, episodes, version, plot_episode, alpha = 1e-4, gamma = 0.99, beta = 0.01, update_steps = 10):
    ...
    for episode in tqdm(range(1, episodes + 1)):
        ...
        if episode in plot_episode:
            plot_prog(env, episode, net, version ,"figures", "a2c_batched" )
    return stats
