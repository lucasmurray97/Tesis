...
# plt.clf()
# plt.matshow(mat)
# plt.savefig(f"figures/{version}/reinforce/{episodes}_ep/trajectory/initial_state.png")
# plt.show()
# for i in range(100):
#     mat = state[0].reshape(20,20).numpy()
#     a = policy(state)
...
#     plt.savefig(f"figures/{version}/reinforce/{episodes}_ep/probabilities/post_train/probs_after_training_"+ str(i) +".png")
#     plt.show()
...
#     plt.savefig(f"figures/{version}/reinforce/{episodes}_ep/trajectory/" + str(i) + ".png")
#     plt.show()
