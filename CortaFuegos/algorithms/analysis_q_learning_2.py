...
returns, q_table = q_learning(size, env, episodes, env_version, [], alpha = lr, epsilon = eps)

plot_moving_av(returns, episodes, env_version, "", "q_learning_2", window = window, drl = False, test = True, params = {"lr": lr, "eps": eps}, instance = instance)
...
for i in range((size//2)**2):
    ...
    if i == (size//2)**2-1:
        ...
        plt.savefig(f"figures_tuning/{env_version}/{instance}/q_learning_2/trajectory_episodes={episodes}_lr={lr}_eps={eps}.png")
        plt.show()
