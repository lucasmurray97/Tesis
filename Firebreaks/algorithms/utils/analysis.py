...
try:
  ...
  pass
file = open(f"../../../../../../algorithms/dpv/demonstrations/homo_2/history_Sub6x6_full_grid_1.pkl", 'rb')
history = pickle.load(file)
print(dict(sorted(history.items(), key = lambda x: x[1], reverse = True)[:1]))
ignition_rad = 4
sims = 5000
ros_cv = 0.0
