...
data_directory = "/home/lucas/Tesis/Firebreaks/algorithms/enviroment/utils/instances/homo_2/data/Sub20x20/"
results_directory = "/home/lucas/Tesis/Firebreaks/algorithms/enviroment/utils/instances/homo_2/results/Sub20x20/"
try:
  shutil.rmtree(f'{results_directory}Grids/')
except:
  pass
n_sims = 500
sys.argv = ['main.py', '--input-instance-folder', data_directory, '--output-folder', results_directory, '--ignitions', '--sim-years', '1', '--nsims', str(n_sims), '--finalGrid', '--weather', 'random', '--nweathers', '10', '--Fire-Period-Length', '1.0', '--ROS-CV', '0.0', '--IgnitionRad', '4','--stats', '--allPlots', '--grids', '--output-messages', '--combine']
main()
base_directory = "/home/lucas/Tesis/Firebreaks/algorithms/enviroment/utils/instances/homo_2/results/Sub20x20/Grids/Grids"
reward = 0
