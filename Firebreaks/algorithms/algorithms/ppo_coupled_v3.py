...
import json
import copy
def ppo(env, net, episodes, env_version, net_version, plot_episode, alpha = 1e-5, gamma = 0.99, beta = 0.02, clip = 0.2, landa = 0.95, n_envs = 8, epochs = 10, batches = 8, batch_size = 64, instance = "sub20x20", test = False, window = 10, demonstrate = True, n_dem = 10, combined = False, temporal = False, max_mem = 1000, target_update = 1):
    ...
    plot_trayectory_probs(env.envs[0], episode, net, env_version, net_version ,"ppo_v3", env.size, instance, test, params = params)
